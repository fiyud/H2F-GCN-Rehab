...
class ConvGRUCell(nn.Module):
    ...
    def init_hidden(self, batch_size):
        return Variable(torch.zeros(batch_size, self.hidden_dim, self.height, self.width)).type(self.dtype).to(self.device)
...
class ConvGRU(nn.Module):
    ...
    def _init_hidden(self, batch_size):
        ...
        for i in range(self.num_layers):
            init_states.append(self.cell_list[i].init_hidden(batch_size).to(self.device))
        return init_states
